    ...
    <form class="form-horizontal" action="edit_request.php" method="post" role="form">
    	<div class="row">
            ...
            <div class="col-sm-4 col-sm-offset-1">
                <div class="checkbox">
                    <label>
                        <input type="checkbox" value="1"><p class="lead">EMERGENCY MAINTENANCE</p>
                    </label>
                </div>
        	</div>
      	</div>
        ...
        <div class="center-text">
            <h3><p class="lead">Subject of Request:</br>Complete A OR B</p></h3>
        </div>
        <div class="row">
            <div class="col-sm-5 col-sm-offset-0">
            	<div class="center-text">
                    <h4><p class="lead">Option A</br>Machine(s)</p></h4>
                </div>
                <div class="form-group">
            ...
            <div class="col-sm-6 col-sm-offset-1">
            	<div class="center-text">
                    <h4><p class="lead">Option B</br>Other</p></h4>
                </div>
                <div class="form-group">
