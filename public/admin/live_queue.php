...
<div class="container col-md-12 col-md-offset-0">
    <div class="center-text">
        <h1><i class="icon-list-ol"></i> Maintenance Queue<a class="btn btn-warning pull-right" href="request.php"><h5><i class="icon-edit"></i> Request</h5></a><a class="btn btn-success pull-right" href="resolved_queue.php"><h5><i class="icon-check"></i> Resolved Requests</h5></a></h1>
