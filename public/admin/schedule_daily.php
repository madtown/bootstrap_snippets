...
<?php
	...
	$photos=$procedureClass->find_daily();
?>
...
<div class="col-md-12 col-md-offset-0">
	<div class="center-text"><h1><i class="icon-sun text-warning"></i> Daily Maintenance</h1></div>
	<?php echo output_message($message); ?>
	<table class="table table-striped table-hover">
		<tr>
		    <th><i class="custom-wrench"></i> Do Procedure</th>
		    <th><i class="icon-cog"></i> Machine</th>
		    <th><i class="custom-stopwatch"></i> Average</th>
		    <th>Machine Type</th>
		    <th><i class="icon-check"></i> Skip</th>
		</tr>
    ...
    <?php //$procedureClass->listProcedures($photos); ?>
    </div>
