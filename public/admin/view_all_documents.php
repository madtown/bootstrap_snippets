...
<div class="col-md-12 col-md-offset-0">
	...
	<?php foreach($photos as $photo): ?>
	  <tr>
		...
		<td style='text-align:center;vertical-align:middle'><a class="btn btn-default" href="view_doc_machines.php?id=<?php echo htmlentities($photo->id); ?>"><i class="icon-cogs icon-4x"></i></a></td>
