<div class="panel-group" id="accordion-cat-8">
        ...
        <div class="panel-heading">
            <a data-toggle="collapse" data-parent="#accordion-cat-8" href="#faq-cat-8-sub-1">
                <h4 class="panel-title lead">
                    <i class="icon-eye-open"></i> Overview
    ...
    <div class="panel panel-default panel-faq">
        <div class="panel-heading">
            <a data-toggle="collapse" data-parent="#accordion-cat-8" href="#faq-cat-8-sub-2">
                <h4 class="panel-title lead">
                    <i class="icon-sun"></i> Daily Report
                    <span class="pull-right"><i class="glyphicon glyphicon-plus"></i></span>
                </h4>
            </a>
        </div>
    ...
    <div class="panel panel-default panel-faq">
        <div class="panel-heading">
            <a data-toggle="collapse" data-parent="#accordion-cat-8" href="#faq-cat-8-sub-3">
                <h4 class="panel-title lead">
                    <i class="icon-list-th"></i> Weekly Report
                    <span class="pull-right"><i class="glyphicon glyphicon-plus"></i></span>
                </h4>
            </a>
        </div>
    ...
    <div class="panel panel-default panel-faq">
        <div class="panel-heading">
            <a data-toggle="collapse" data-parent="#accordion-cat-8" href="#faq-cat-8-sub-4">
                <h4 class="panel-title lead">
                    <i class="icon-moon"></i> Monthly Report
                    <span class="pull-right"><i class="glyphicon glyphicon-plus"></i></span>
                </h4>
            </a>
        </div>
    ...
    <div class="panel panel-default panel-faq">
        <div class="panel-heading">
            <a data-toggle="collapse" data-parent="#accordion-cat-8" href="#faq-cat-8-sub-5">
                <h4 class="panel-title lead">
                    <i class="icon-globe"></i> Bi-Annual Report
                    <span class="pull-right"><i class="glyphicon glyphicon-plus"></i></span>
                </h4>
            </a>
        </div>
    ...
    <h2 class="center-text">Report Components</h2>
    <div class="panel panel-default panel-faq">
        <div class="panel-heading">
            <a data-toggle="collapse" data-parent="#accordion-cat-8" href="#faq-cat-8-sub-6">
                <h4 class="panel-title lead">
                    <i class="custom-stopwatch"></i> Overdue Procedures
                    <span class="pull-right"><i class="glyphicon glyphicon-plus"></i></span>
                </h4>
            </a>
        </div>
    ...
    <div class="panel panel-default panel-faq">
        <div class="panel-heading">
            <a data-toggle="collapse" data-parent="#accordion-cat-8" href="#faq-cat-8-sub-7">
                <h4 class="panel-title lead">
                    <i class="icon-warning-sign"></i> Corrective Action
                    <span class="pull-right"><i class="glyphicon glyphicon-plus"></i></span>
                </h4>
            </a>
        </div>
    ...
    <div class="panel panel-default panel-faq">
        <div class="panel-heading">
            <a data-toggle="collapse" data-parent="#accordion-cat-8" href="#faq-cat-8-sub-8">
                <h4 class="panel-title lead">
                    <i class="icon-unchecked"></i> Preventable
                    <span class="pull-right"><i class="glyphicon glyphicon-plus"></i></span>
                </h4>
            </a>
        </div>
    ...
    <div class="panel panel-default panel-faq">
        <div class="panel-heading">
            <a data-toggle="collapse" data-parent="#accordion-cat-8" href="#faq-cat-8-sub-9">
                <h4 class="panel-title lead">
                    <i class="icon-check"></i> Unpreventable
                    <span class="pull-right"><i class="glyphicon glyphicon-plus"></i></span>
                </h4>
            </a>
        </div>
    ...
    <div class="panel panel-default panel-faq">
        <div class="panel-heading">
            <a data-toggle="collapse" data-parent="#accordion-cat-8" href="#faq-cat-8-sub-10">
                <h4 class="panel-title lead">
                    <i class="custom-cd"></i> Cause Percentage Donut Chart
                    <span class="pull-right"><i class="glyphicon glyphicon-plus"></i></span>
                </h4>
            </a>
        </div>
    ...
    <div class="panel panel-default panel-faq">
        <div class="panel-heading">
            <a data-toggle="collapse" data-parent="#accordion-cat-8" href="#faq-cat-8-sub-11">
                <h4 class="panel-title lead">
                    <i class="custom-chart-pie-1"></i> Post Pie Chart
                    <span class="pull-right"><i class="glyphicon glyphicon-plus"></i></span>
                </h4>
            </a>
        </div>
        <div id="faq-cat-8-sub-11" class="panel-collapse collapse">
            <div class="panel-body">
            	This is some stuff
            </div>
        </div>
    ...
    <div class="panel panel-default panel-faq">
        <div class="panel-heading">
            <a data-toggle="collapse" data-parent="#accordion-cat-8" href="#faq-cat-8-sub-12">
                <h4 class="panel-title lead">
                    <i class="custom-chart-bar"></i> Causes Breakdown Bar Chart
                    <span class="pull-right"><i class="glyphicon glyphicon-plus"></i></span>
                </h4>
            </a>
        </div>
    ...
    <div class="panel panel-default panel-faq">
        <div class="panel-heading">
            <a data-toggle="collapse" data-parent="#accordion-cat-8" href="#faq-cat-8-sub-13">
                <h4 class="panel-title lead">
                    <i class="custom-chart-line"></i> Causes Breakdown Line Chart
                    <span class="pull-right"><i class="glyphicon glyphicon-plus"></i></span>
                </h4>
            </a>
        </div>
